...
public class ConfigCommand implements Callable<Integer> {
    ...
    public static class PrefixesCommand implements Callable<Integer> {
        ...
        public Integer call() {
            ...
            System.out.println(
                "  ingenious run testset -r R1 -t Smoke --capability \"Chrome.--headless=new\""
            );
            System.out.println(
                "  ingenious run testcase Login/Smoke --lambdatest-cap \"build=ci-1234\""
            );
            System.out.println(
                "  ingenious -run -project_location ./proj -release R1 -testset Smoke \\"
            );
            System.out.println(
                "            -setEnv \"device.Pixel5.RemoteURL=http://hub:4723/;tmModule.AzureDO.collection=https://dev.azure.com/x\""
            );
            return 0;
        }
    }
