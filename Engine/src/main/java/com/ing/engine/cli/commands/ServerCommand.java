...
public class ServerCommand implements Callable<Integer> {
    ...
    public static class McpCommand implements Callable<Integer> {
        ...
        @Option(names = {"-p", "--project"}, description = "Default project (name or absolute path)")
        ...
        public Integer call() {
            ...
            if (verbose) {
                ...
                System.err.println("[mcp] default project: "
    ...
    public static class StatusCommand implements Callable<Integer> {
        ...
        public Integer call() {
            ...
            try {
                ...
                if (code == 200) cli.printSuccess("Server is running on port " + port);
