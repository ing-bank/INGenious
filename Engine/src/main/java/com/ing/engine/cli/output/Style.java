...
public final class Style {
    ...
    public String bold(Object v) {
        return wrap(BOLD, v);
    }

    public String dim(Object v) {
        return wrap(DIM, v);
    }

    public String italic(Object v) {
        return wrap(ITALIC, v);
    }

    public String red(Object v) {
        return wrap(FG_RED, v);
    }

    public String green(Object v) {
        return wrap(FG_GREEN, v);
    }

    public String yellow(Object v) {
        return wrap(FG_YELLOW, v);
    }

    public String blue(Object v) {
        return wrap(FG_BLUE, v);
    }

    public String magenta(Object v) {
        return wrap(FG_MAGENTA, v);
    }

    public String cyan(Object v) {
        return wrap(FG_CYAN, v);
    }

    public String white(Object v) {
        return wrap(FG_WHITE, v);
    }

    public String grey(Object v) {
        return wrap(FG_GREY, v);
    }
