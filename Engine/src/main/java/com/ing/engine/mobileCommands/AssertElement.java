...
public class AssertElement extends MobileGeneral {
	...
	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] is not present")
	public void assertElementNotPresent() {
		assertNotElement(!elementPresent());
	}

	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] is not selected")
	public void assertElementNotSelected() {
		assertNotElement(!elementSelected());
	}

	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] is not displayed")
	public void assertElementNotDisplayed() {
		assertNotElement(!elementDisplayed());
	}

	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] is not enabled")
	public void assertElementNotEnabled() {
		assertNotElement(!elementEnabled());
	}

	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] is present")
	public void assertElementPresent() {
		assertElement(elementPresent());
	}

	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] element is selected")
	public void assertElementSelected() {
		assertElement(elementSelected());
	}

	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] element is displayed")
	public void assertElementDisplayed() {
		assertElement(elementDisplayed());
	}

	@Action(object = ObjectType.MOBILE, desc = "Assert if [<Object>] is enabled on the current page")
