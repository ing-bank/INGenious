...
public final class ActionCatalog {
        ...
        for (String className : COMMAND_CLASSES) {
            try {
                ...
                for (Method method : clazz.getDeclaredMethods()) {
                    ...
                    String effective = (objType == null || objType.isEmpty()
                            || "Any".equalsIgnoreCase(objType))
                            ? defaultObjType : objType;
                    String category = CATEGORY.getOrDefault(normalize(effective), "General");
                    unique.putIfAbsent(method.getName(), new ActionInfo(
                            method.getName(),
                            category,
                            effective,
                            a.desc(),
    ...
    public static final class ActionInfo {
        ...
        public ActionInfo(String name, String category, String objectType,
                          String description, String inputRequired, String conditionSupported) {
            this.name = name;
