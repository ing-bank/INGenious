...
public class Dialogs extends General {
    ...
    @Action(
        ...
        desc = "Answer the next alert with [<Data>]",
        input = InputType.YES
    )
    public void answerNextAlert() {
        ...
        try {
            ...
            Report.updateTestLog(
                Action,
                "Message '" + setAlertText + "' will be set in the next alert window",
                Status.DONE
            );
        } catch (Exception e) {
    ...
    @Action(
        object = ObjectType.BROWSER,
        desc = "Answer all the alerts with [<Data>]",
        input = InputType.YES
    )
    public void answerAllAlerts() {
        ...
        try {
            ...
            Report.updateTestLog(
                Action,
                "Message '" + setAlertText + "' will be set in all the alert windows",
                Status.DONE
            );
        } catch (Exception e) {
            Report.updateTestLog(Action, e.getMessage(), Status.FAILNS);
    ...
    public void dismissAllAlerts() {
        try {
            ...
            Report.updateTestLog(Action, "All alerts will be dismissed", Status.DONE);
        } catch (Exception e) {
            Report.updateTestLog(Action, e.getMessage(), Status.FAILNS);
            Logger.getLogger(CommonMethods.class.getName()).log(Level.SEVERE, null, e);
            throw new ActionException(e);
    ...
    public void dismissNextAlert() {
        try {
            ...
            Report.updateTestLog(Action, "Next alert will be dismissed", Status.DONE);
        } catch (Exception e) {
            Report.updateTestLog(Action, e.getMessage(), Status.FAILNS);
            Logger.getLogger(CommonMethods.class.getName()).log(Level.SEVERE, null, e);
            throw new ActionException(e);
    ...
    @Action(
        object = ObjectType.BROWSER,
        desc = "Store next Alert message into the Runtime variable: [<Data>]",
        input = InputType.YES
    )
    ...
    @Action(
        object = ObjectType.BROWSER,
        desc = "Store Alert type into the Runtime variable: [<Data>]",
        input = InputType.YES
    )
            ...
            Page.onceDialog(
                dialog -> {
                    if (strObj.startsWith("%") && strObj.endsWith("%")) {
                        ...
                        Report.updateTestLog(
                            Action,
                            "Alert Type " + dialog.type() + " is stored in variable " + strObj,
                            Status.DONE
                        );
                    } else {
                        Report.updateTestLog(Action, "Invalid variable format", Status.DEBUG);
    ...
    @Action(
        object = ObjectType.BROWSER,
        desc = "Store default Alert value into the Runtime variable: [<Data>]",
        input = InputType.YES
    )
