...
public class MobileObject {
    ...
    public MobileObject(AndroidDriver Driver) {
        System.out.println("@@@@ Inside Mobile Object ");
        this.driver = Driver; 
    }
    ...
    public WebElement findElement(String objectKey, String pageKey) {
    	System.out.println("**** inside do AutomationObject --> findElement : "+objectKey +"   : "+ pageKey);
    ...
    public WebElement findElement(String objectKey, String pageKey, FindmType condition) {
    	System.out.println("**** inside do AutomationObject --> findElement 1 : "+objectKey +"   : "+ pageKey +"   : "+condition);       
//       String a= driver.findElement(By.xpath("//android.widget.TextView[@text=\"Login\"]"));
    ...
    public WebElement findElement(SearchContext element, String objectKey, String pageKey, FindmType condition) {
        ...
        findType = condition;
        System.out.println("**** inside do AutomationObject --> findElement 2 : "+objectKey +"   : "+ pageKey +"   : "+condition);
    ...
    private synchronized List<WebElement> findElements(SearchContext context, ObjectGroup objectGroup, String prop) {
    	System.out.println("***** inside findElements AutomationObject --> findElements 4 ");
        if (objectGroup != null && !objectGroup.getObjects().isEmpty()) {
            if (objectGroup.getObjects().get(0) instanceof WebORObject) {
            	System.out.println("***** inside findElements AutomationObject WebOrInstance");
                return getWElements(context, objectGroup, prop);
            } else if (objectGroup.getObjects().get(0) instanceof MobileORObject) {
            	System.out.println("***** inside findElements AutomationObject MobileOrInstance");
    ...
    private List<WebElement> getMElements(SearchContext context, ObjectGroup<MobileORObject> objectGroup, String prop) {
    	System.out.println("**** Inside AutomationObject --> getMElements :");
        long startTime = System.nanoTime();
        List<WebElement> elements = null;
    ...
    private List<WebElement> getElements(final SearchContext context, final List<ORAttribute> attributes,
            final String prop) {
    	System.out.println("**** Inside AutomationObject --> getMElements 1 :");
                    ...
                    if (!attr.getValue().trim().isEmpty()) {
                        ...
                        if (elements != null) {
                            return elements;
                        	 ...
                        	 System.out.println("Inside Automation Mobile Object else if tag : "+tag+"    value : "+value);
