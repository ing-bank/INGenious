...
public class Border {
    ...
    public static javax.swing.border.Border transBorder = BorderFactory.createMatteBorder(
        2,
        2,
        2,
        2,
        new Color(255, 255, 255, 0)
    ), focusBorder = BorderFactory.createMatteBorder(
        2,
        2,
        2,
        2,
        ...
        0,
        Color.decode("#13BEFF")
    ), thumbPrevOnFocus = new LineBorder(
        Color.decode("#9E9E9E"),
        3
    ), thumbPrevOffFocus = new LineBorder(
        Color.decode("#BDBDBD"),
        3
