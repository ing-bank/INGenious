...
public class QuitConfirmationDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        if (includeCancel) {
            JButton cancelBtn = createButton(
                "Cancel",
        ...
        // Don't Save button
        JButton dontSaveBtn = createButton(
            "Don't Save",
            MaterialDesignE.EXIT_RUN,
            DONT_SAVE_BTN_BG,
            DONT_SAVE_BTN_HOVER,
            false
        );
        dontSaveBtn.addActionListener(
            e -> {
