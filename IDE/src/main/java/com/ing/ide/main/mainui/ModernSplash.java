...
public class ModernSplash extends JFrame {
    ...
    private void initComponents() {
        ...
        setShape(
            new java.awt.geom.RoundRectangle2D.Double(0, 0, SPLASH_WIDTH, SPLASH_HEIGHT, 24, 24)
        );
    }
    ...
    private class SplashPanel extends JPanel {
        ...
        private void drawProgressRing(Graphics2D g2d) {
            ...
            g2d.setStroke(
                new BasicStroke(RING_THICKNESS, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND)
            );
            g2d.draw(
            ...
            if (animatedProgress > 0) {
                ...
                if (animatedProgress < 100) {
                    ...
                    RadialGradientPaint edgeGlow = new RadialGradientPaint(
                        ...
                        new Color[] {
                            new Color(
                                ING_PURPLE_LIGHT.getRed(),
                                ING_PURPLE_LIGHT.getGreen(),
                                ING_PURPLE_LIGHT.getBlue(),
                                180
                            ),
                            new Color(0, 0, 0, 0)
                        }
        ...
        private void drawAppName(Graphics2D g2d) {
            ...
            GradientPaint textGradient = new GradientPaint(
                centerX - fm.stringWidth(appName) / 2f,
                y,
                ING_PURPLE_LIGHT,
                centerX + fm.stringWidth(appName) / 2f,
                y,
        ...
        private void drawStepIndicators(Graphics2D g2d) {
            ...
            for (int i = 0; i < LOADING_STEPS.length; i++) {
                ...
                boolean isCurrent = i < LOADING_STEPS.length - 1
                    ...
                    targetProgress < STEP_THRESHOLDS[i + 1]
                    : targetProgress >= STEP_THRESHOLDS[i];
