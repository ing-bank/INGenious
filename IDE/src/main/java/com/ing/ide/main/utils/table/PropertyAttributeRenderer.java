...
public class PropertyAttributeRenderer extends DefaultTableCellRenderer {
    ...
    static {
        ...
        ATTRIBUTE_STYLES.put(
            "Placeholder",
            new AttributeStyle(MaterialDesignF.FORM_TEXTBOX, CLR_PLACEHOLDER)
        );
        ...
        ATTRIBUTE_STYLES.put(
            "UiAutomator",
            new AttributeStyle(MaterialDesignA.ANDROID, CLR_MOBILE_AUTO)
        );
        ATTRIBUTE_STYLES.put(
            "UiAutomation",
            new AttributeStyle(MaterialDesignA.APPLE, CLR_MOBILE_AUTO)
        );
        ATTRIBUTE_STYLES.put("id", new AttributeStyle(MaterialDesignI.IDENTIFIER, CLR_MOBILE_ID));
        ATTRIBUTE_STYLES.put(
            "Accessibility",
            new AttributeStyle(MaterialDesignH.HUMAN_HANDSUP, CLR_MOBILE_ACCESS)
        );
        ATTRIBUTE_STYLES.put("name", new AttributeStyle(MaterialDesignT.TAG_TEXT, CLR_MOBILE_NAME));
        ATTRIBUTE_STYLES.put(
            "tagName",
            new AttributeStyle(MaterialDesignC.CODE_BRACKETS, CLR_MOBILE_TAG)
        );
        ATTRIBUTE_STYLES.put(
            "link_text",
            new AttributeStyle(MaterialDesignL.LINK, CLR_MOBILE_LINK)
        );
        ATTRIBUTE_STYLES.put(
            "class",
            new AttributeStyle(MaterialDesignC.CODE_BRACES, CLR_MOBILE_CLASS)
        );

        // ===== API Attributes =====
        ATTRIBUTE_STYLES.put(
            "JsonPath",
            new AttributeStyle(MaterialDesignC.CODE_JSON, CLR_API_JSONPATH)
        );
