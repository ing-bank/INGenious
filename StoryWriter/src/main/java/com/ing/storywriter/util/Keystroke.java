...
public class Keystroke {
    public static final KeyStroke comment = KeyStroke.getKeyStroke(
        KeyEvent.VK_SLASH,
        Event.CTRL_MASK
    );
    ...
    public static final KeyStroke addrow = KeyStroke.getKeyStroke(
        KeyEvent.VK_EQUALS,
        Event.CTRL_MASK
    );
    public static final KeyStroke addrowx = KeyStroke.getKeyStroke(
        KeyEvent.VK_PLUS,
        Event.CTRL_MASK
    );
    public static final KeyStroke removerow = KeyStroke.getKeyStroke(
        KeyEvent.VK_MINUS,
        Event.CTRL_MASK
    );
    ...
    public static final KeyStroke back = KeyStroke.getKeyStroke(
        KeyEvent.VK_DOWN,
        KeyEvent.ALT_MASK
    );
    public static final KeyStroke next = KeyStroke.getKeyStroke(KeyEvent.VK_UP, KeyEvent.ALT_MASK);
    public static final KeyStroke addcol = KeyStroke.getKeyStroke(
        KeyEvent.VK_EQUALS,
        Event.ALT_MASK
    );
    public static final KeyStroke addcolx = KeyStroke.getKeyStroke(
        KeyEvent.VK_PLUS,
        Event.ALT_MASK
    );
    public static final KeyStroke removecol = KeyStroke.getKeyStroke(
        KeyEvent.VK_MINUS,
        Event.ALT_MASK
    );
}
